...
const features = [
  ...
  },
  {
    // Target icon
    icon: (
      <svg className="w-8 h-8 sm:w-10 sm:h-10" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/></svg>
    ),
  ...
  },
  {
    // Conveyor belt icon
    icon: (
      <svg className="w-8 h-8 sm:w-10 sm:h-10" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><rect x="2" y="14" width="20" height="4" rx="2"/><rect x="6" y="6" width="12" height="6" rx="2"/><circle cx="6" cy="18" r="2"/><circle cx="18" cy="18" r="2"/></svg>
    ),
  ...
  },
  {
    // Award/trophy icon
    icon: (
      <svg className="w-8 h-8 sm:w-10 sm:h-10" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path d="M8 21h8M12 17v4M17 5V3a1 1 0 0 0-1-1H8a1 1 0 0 0-1 1v2a5 5 0 0 0 10 0z"/><path d="M17 5a5 5 0 0 1-10 0"/></svg>
    ),
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-16 sm:mb-20">
          {features.map((feature, idx) => (
            <div
              key={idx}
              className="flex flex-col items-center bg-white rounded-2xl shadow-lg border border-gray-100 px-6 py-10 min-h-[30px] transition-all duration-300 hover:-translate-y-2 hover:shadow-2xl hover:border-blue-400 group"
            >
              <div className="mb-6 text-blue-600 group-hover:scale-110 transition-transform duration-300">
                {feature.icon}
              </div>
              <h3 className="text-xl font-bold text-gray-800 text-center mb-3" style={{ fontFamily: 'Playfair Display, serif' }}>
                {feature.label}
              </h3>
